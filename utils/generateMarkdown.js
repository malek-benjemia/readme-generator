...
function renderLicenseBadge(license) {
  if (license) {
    ...
    if (license=='Apache License 2.0') {return '<img src=https://img.shields.io/badge/License-Apache%202.0-blue.svg>';} ;
    if (license=='GNU General Public License v3.0'){return '<img src=https://img.shields.io/badge/License-GPLv3-blue.svg>';};
    if (license== 'MIT License') {return '<img src=https://img.shields.io/badge/License-MIT-yellow.svg>';};
    ...
    if (license=='Boost Software License 1.0') {return '<img src=https://img.shields.io/badge/License-Boost%201.0-lightblue.svg>';};
    if (license=='Creative Commons Zero v1.0 Universal') {return '<img src=https://licensebuttons.net/l/zero/1.0/80x15.png>';};
    if (license=='Eclipse Public License 2.0') {return '<img src=https://img.shields.io/badge/License-EPL%201.0-red.svg>';};
    if (license=='GNU Affero General Public License v3.0') {return '<img src=https://img.shields.io/badge/License-AGPL%20v3-blue.svg>';};
    if (license=='GNU General Public License v2.0') {return '<img src=https://img.shields.io/badge/License-GPL%20v2-blue.svg>';};
...
function renderLicenseLink(license) {
  if (license) {
    if (license=='None') {return '';};
    if (license=='Apache License 2.0') {return '<a href="https://opensource.org/licenses/Apache-2.0">';} ;
    if (license=='GNU General Public License v3.0'){return '<a href="https://www.gnu.org/licenses/gpl-3.0">';};
    if (license== 'MIT License') {return '<a href="https://opensource.org/licenses/MIT">';};
    ...
    if (license=='Boost Software License 1.0') {return '<a href="https://www.boost.org/LICENSE_1_0.txt">';};
    if (license=='Creative Commons Zero v1.0 Universal') {return '<a href="http://creativecommons.org/publicdomain/zero/1.0/">';};
    if (license=='Eclipse Public License 2.0') {return '<a href="https://opensource.org/licenses/EPL-1.0">';};
    if (license=='GNU Affero General Public License v3.0') {return '<a href="https://www.gnu.org/licenses/agpl-3.0">';};
    if (license=='GNU General Public License v2.0') {return '<a href="https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html">';};
